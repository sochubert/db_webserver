...
router.get('/', function(req, res, next) {
  if(!req.cookies['customer_id']){
    res.render('reservation', { title: 'Reservation', cust_info:null, avail_roomtype:null,reservation_info:null});
  } else {
    res.render('reservation', { title: 'Reservation', cust_info:[req.cookies.customer_id, req.cookies.customer_name, false], avail_roomtype:null,reservation_info:null});
  }
